...
# S3 config
AWS_ACCESS_KEY = os.environ.get('WEAREBNB_AWS_ACCESS_KEY')
AWS_SECRET_KEY = os.environ.get('WEAREBNB_AWS_SECRET_KEY')
S3_BUCKET_NAME = os.environ.get('WEAREBNB_S3_BUCKET_NAME')
